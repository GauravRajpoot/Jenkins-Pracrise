...
import com.nagarro.com.learning.Jenkins;

import utils.v2.ExtentManager;
import utils.v2.ExtentTestManager;
public class TestListenerv2 extends Jenkins implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
       System.out.println(getTestMethodName(iTestResult) + " test is failed.");
        ...
        String base64Screenshot =
            "data:image/png;base64," + ((TakesScreenshot) Objects.requireNonNull(this.driver)).getScreenshotAs(OutputType.BASE64);
